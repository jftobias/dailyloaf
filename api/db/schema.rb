...
ActiveRecord::Schema[8.1].define(version: 2026_09_21_070001) do
  ...
  create_table "accounts", force: :cascade do |t|
    ...
    t.check_constraint "account_type::text = ANY (ARRAY['cash'::character varying::text, 'checking'::character varying::text, 'savings'::character varying::text, 'credit_card'::character varying::text, 'loan'::character varying::text, 'investment'::character varying::text, 'other_asset'::character varying::text, 'other_liability'::character varying::text])", name: "accounts_type_valid"
    t.check_constraint "credit_limit IS NULL OR account_type::text = 'credit_card'::text", name: "accounts_credit_limit_card_only"
    t.check_constraint "credit_limit IS NULL OR credit_limit > 0::numeric", name: "accounts_credit_limit_positive"
    ...
    t.check_constraint "visibility::text = ANY (ARRAY['shared'::character varying::text, 'private'::character varying::text])", name: "accounts_visibility_valid"
  end
  ...
  create_table "categories", force: :cascade do |t|
    ...
    t.check_constraint "kind::text = ANY (ARRAY['income'::character varying::text, 'expense'::character varying::text])", name: "categories_kind_valid"
    ...
    t.check_constraint "visibility::text = ANY (ARRAY['shared'::character varying::text, 'private'::character varying::text])", name: "categories_visibility_valid"
  end
  ...
  create_table "financial_transactions", force: :cascade do |t|
    ...
    t.check_constraint "(kind::text = ANY (ARRAY['income'::character varying::text, 'expense'::character varying::text])) AND category_id IS NOT NULL OR (kind::text = ANY (ARRAY['transfer'::character varying::text, 'balance_adjustment'::character varying::text])) AND category_id IS NULL", name: "financial_transactions_category_valid"
    t.check_constraint "kind::text = 'income'::text AND account_impact > 0::numeric OR kind::text = 'expense'::text AND account_impact < 0::numeric OR (kind::text = ANY (ARRAY['transfer'::character varying::text, 'balance_adjustment'::character varying::text]))", name: "financial_transactions_sign_valid"
    t.check_constraint "kind::text = ANY (ARRAY['income'::character varying::text, 'expense'::character varying::text, 'transfer'::character varying::text, 'balance_adjustment'::character varying::text])", name: "financial_transactions_kind_valid"
    t.check_constraint "status::text = ANY (ARRAY['pending'::character varying::text, 'posted'::character varying::text])", name: "financial_transactions_status_valid"
  end
  ...
  create_table "household_memberships", force: :cascade do |t|
    ...
    t.check_constraint "role::text = ANY (ARRAY['owner'::character varying::text, 'member'::character varying::text])", name: "household_memberships_role_valid"
  end
  ...
  create_table "transfers", force: :cascade do |t|
    ...
    t.check_constraint "status::text = ANY (ARRAY['pending'::character varying::text, 'posted'::character varying::text])", name: "transfers_status_valid"
  end
